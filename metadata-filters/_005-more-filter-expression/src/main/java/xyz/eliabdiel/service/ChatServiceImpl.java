    ...
    public List<Document> search(String query) {
        ...
        return vectorStore.similaritySearch(
                SearchRequest.builder()
                        .query(query)
                        .filterExpression(
//                                filterExpression.in("brand","Dell","Apple")
//                                filterExpression.nin("brand","Dell","Apple","HP")
//                                filterExpression.not(filterExpression.eq("brand","Apple"))
//                                filterExpression.not(filterExpression.in("brand","Apple","Dell"))
//                                        .build()
//                                "brand in ['Samsung'] or brand in ['Apple']"
                                "brand in ['Samsung'] && price > 500"
                        )
                        .topK(5)
                        .build()
        );
